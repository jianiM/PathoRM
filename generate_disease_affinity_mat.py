...
if __name__=="__main__": 
    ...
    parser = argparse.ArgumentParser(description="disease-feature")
    parser.add_argument("--root_path", type=str, required=True)
    parser.add_argument("--dataset", type=str, required=True)
    parser.add_argument("--go_file", type=str, required=True)
    parser.add_argument("--semantic_file", type=str, required=True)
    ...
    # site feature 
    go_path = os.path.join(root_path,dataset,go_file)
    semantic_path = os.path.join(root_path,dataset,semantic_file)
    
    go = pd.read_excel(go_path,header=None).values    
